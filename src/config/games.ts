...
export const GAME_CATALOG: GameMeta[] = [
  {
    ...
    tagline: "信じるか、裏切るか。",
    description: "自分の意図を宣言しつつ「信頼」か「裏切り」を選び、3ラウンドの合計点で勝敗を決める心理戦。",
    rules: [
  ...
  },
  {
    ...
    tagline: "少数派に立て。",
    description: "自分の狙いを宣言しつつ、群衆の傾向を読んでAかBの少数派を選び続ける3ラウンドの心理戦。",
    rules: [
      "まずAかBのどちらを選ぶか「宣言」する（相手にも見える。本当でも嘘でもよい）",
      "相手の宣言を見たうえで、最終的な選択を「ロックイン」する（宣言と違う選択でもよい）",
      "観衆（BOT集団）も同時にAかBを選ぶ",
  ...
  },
  {
    ...
    tagline: "その一手を読み切れ。",
    description: "「攻撃」「防御」「見破る」の三すくみを5ラウンド、宣言と読み合いで相手を出し抜く。",
    rules: [
